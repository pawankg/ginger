...
import wok.plugins.ginger.models.dasddevs as dasddevs
from wok.plugins.ginger.models.dasd_utils import _parse_lsdasd_output


class DASDdevsTests(unittest.TestCase):

    def test_get_lsdasd_devs(self):
        dasd = dasddevs.DASDdevsModel()
        dasd_list = dasd.get_list()
        self.assertGreaterEqual(len(dasd_list), 0)
